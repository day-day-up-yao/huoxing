...
const folderAddressTest = 'www.marslib.com'
const folderAddressPrd = 'www.huoxing24.com.temp'
...
if (env === 'production') {
    config = {
        redisIp: 'r-j6cwzd7dvux3iybide.redis.rds.aliyuncs.com', // 外网IP:39.105.139.238
