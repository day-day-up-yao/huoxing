window.onload = function () {
    var styleSheet = 'body,div,p,a,h1,h3{margin:0;padding:0;font-family:"Microsoft YaHei UI Light","Microsoft YaHei";font-weight:normal}' +
        ...
        '.browser-tips-mask{position:fixed;left:0;top:0;background:url("http://common.8864.com/web/img/black-bg.png");height:100%;width:100%;z-home.js:9998;}' +
        '.browser-tips{margin-left:-300px;position:fixed;left:50%;top:200px;background:#fff;border-radius:5px;height:450px;width:600px;color:#454545;z-home.js:9999;}' +
