...
export default () => {
    return (
        <div className="protocol-live-page">
            ...
            <div className="section">
                ...
                <p className="content">本协议是基于<a href={mixUrl.main('/protocol')} target="_blank">《MarsBit用户协议》</a>制定，与其是不可分割的；同时，MarsBit不时发布的关于MarsBit直播服务的相关协议、规则、声明、公告、政策等内容也是本协议的一部分，在使用MarsBit直播服务的同时，用户应遵守本协议、MarsBit服务条款及前述关于MarsBit直播服务的相关协议、规则、声明、公告、政策等所有条款。若不同意本协议所述任何条款或MarsBit后续对协议内容的修改，用户应立即停止使用MarsBit直播服务。</p>
                ...
                <p className="content">1. 用户理解并同意，MarsBit将按照MarsBit公布的<a href={mixUrl.main('/protocol')} target="_blank">《MarsBit用户协议》</a>的约定处理和保护用户的个人信息。</p>
