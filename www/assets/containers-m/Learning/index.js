...
class Learning extends Component {
    ...
    tabListLen = (arr) => {
        let oneNewsTab = []
        let oneNewsLen = Math.ceil(arr.length / 20)
    ...
    handClickOneNews = (e, arr) => {
        ...
        let contList = arr.slice(index * 20, (index + 1) * 20)
        this.setState({
            oneNewsTab: {
                index: index,
    ...
    render () {
        ...
        return <div className='m-learning-cont'>
            ...
            <div className='lerning-cont-wrap clearfix'>
                ...
                <div className='wrap-left-item clearfix'>
                    <div className='left-cont'>
                        <LearningTitle title={'区块链入门到精通'} url={mixUrl.news('/userCenter/8873ee080e6040538009ac2805ec5549')} introduce={'晋级，提升你对区块链的专业认知'}/>
                        <LearningNewsList cont={twoVideoTab.contList} show={true} more={false}/>
                    </div>
                </div>
                <div className='wrap-item clearfix'>
                    <LearningTitle title={'区块链公开课'} url={mixUrl.news('/tags/MarsBit公开课')} introduce={'行业最前线，区块链从业者专题知识分享'}/>
                ...
                <div className='wrap-item clearfix' style={{ display: 'none' }}>
