...
import { scrollOffset, windowScroll, elementOffset, rem } from 'multiPublic/index'

export default () => {
    const [nowType, setNowType] = useState('jobList1') // 当前选中标签

    useEffect(() => {
        windowScroll(function () {
            let JobTabTop = rem(elementOffset(document.getElementById('fixedTop')).top)
            let windowH = rem(scrollOffset().top + 80)
    ...
    const addClassActive = useCallback(
        () => {
            ...
            windowH = windowH.replace(reg, '')
            for (let i = 1; i <= 5; i++) {
                let list = rem(elementOffset(document.getElementById(`jobList${i}`)).top - 160)
                list = list.replace(reg, '')
                if (Number(windowH) > Number(list)) {
                    setNowType(`jobList${i}`)
                }
            }
        },
        []
    ...
    return (
        <div className="m-job-page">
            <div className="job-banner"></div>
            <div className="job-layout">
                <div className="job-cont">
                    <h3>在MarsBit，我们专注于做好以下2个产品及业务</h3>
                    <p>
                        1. MarsBit：专注区块链与数字经济，详情请关注<a href="https://www.huoxing24.com/">https://www.huoxing24.com/</a><br />
                        2. MarsBit云矿：一站式实体矿机算力服务平台，详情请关注<a href="https://www.mclouds.io/">https://www.mclouds.io/</a><br />
                        {/* 3. MarsBit交易大师：数字资产交易服务和资产管理工具，详情请关注<a href="https://trade.huoxing24.com/">https://trade.huoxing24.com/</a> */}
                    </p>
                    <p>公司具有积极向上的团队精神和工作氛围，在我们事业迅速发展的今天，诚邀那些坚持进取、开放心态、创新意识、诚信正直的有志之士加盟，公司将提供施展才华的广阔发展空间和与之相称的优厚待遇，包括但不限于：五险一金、商业保险、餐补、通讯补贴、团建、节假日礼品、千平米超大办公室，另外，你将获得无与伦比的深入区块链行业的发展机会，更多福利等你来发掘。</p>
                    <span id="fixedTop"></span>
                    <div className="job-tab" id="jobTab">
                        <p className={`p1 ${nowType === 'jobList1' ? 'active' : ''}`} onClick={() => onBtnTypeClick('jobList1')}>产品</p>
                        <p className={`p2 ${nowType === 'jobList2' ? 'active' : ''}`} onClick={() => onBtnTypeClick('jobList2')}>设计</p>
                        <p className={`p3 ${nowType === 'jobList3' ? 'active' : ''}`} onClick={() => onBtnTypeClick('jobList3')}>研发</p>
                        <p className={`p4 ${nowType === 'jobList4' ? 'active' : ''}`} onClick={() => onBtnTypeClick('jobList4')}>内容</p>
                        <p className={`p5 ${nowType === 'jobList5' ? 'active' : ''}`} onClick={() => onBtnTypeClick('jobList5')}>运营</p>
                    </div>
                    <div className="job-list-cont">
                        <div className="job-list" id="jobList1">
                            <h5>DeFi产品经理</h5>
                            <p>
                        ...
                        <div className="job-list" id="jobList2">
                            <h5>高级视觉设计师</h5>
                            <p>
                        ...
                        <div className="job-list" id="jobList3">
                            <h5>DeFi智能合约开发工程师</h5>
                            <h6>岗位职责：</h6>
                            <p>
                        ...
                        <div className="job-list">
                            ...
                            <p>
                                ...
                                3、深入产业，从业务角度出发提升公司产品的内容影响力和品牌建设
                            </p>
                            <h6>任职要求：</h6>
                            <p>
                                1、本科及以上学历，科技金融、经济学、中文、新闻等专业优先<br />
                        ...
                        <div className="job-list" id="jobList5">
                            <h5>用户增长经理</h5>
                            <h6>岗位职责：</h6>
                            <p>
                                1、参与MarsBit旗下产品的用户增长，包括新增、留存、转化<br />
                        ...
                        <div className="job-bottom">
                            ...
                            <p>有意者请通过以下方式联系HR</p>
                            <p className="phone">HR微信（13810850996）</p>
                            <p className="wx">邮箱：hxhr@huoxing24.com</p>
                        </div>
                    </div>
                </div>
            </div>
