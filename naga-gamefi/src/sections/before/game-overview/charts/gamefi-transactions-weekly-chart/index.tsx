...
const GameOverviewTransactionsWeeklyChart = (props: any) => {
  const theme = useTheme();
  const option = useMemo(
    () => ({
      title: {
        text: 'GameFi Transactions (Weekly)',
        textStyle: {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          const dom = `
                  <div class="game-overview-transactions-weekly-chart-tooltip">
  ...
  useEffect(() => {
    // 获取图表容器
    const ele = document.querySelector('#transactions-weekly-chart');
  ...
  return <div className="game-overview-transactions-weekly-chart" id="transactions-weekly-chart" />;
};

export default GameOverviewTransactionsWeeklyChart;
