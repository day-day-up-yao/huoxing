...
const GameOverviewTransactionsChart = (props: any) => {
  const theme = useTheme();
  const option = useMemo(
    () => ({
      title: {
        text: 'GameFi Daily Transactions',
        textStyle: {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          const dom = `
                  <div class="game-overview-transactions-chart-tooltip">
      ...
      yAxis: {
        name: 'Sum of Number Of Transactions',
        // 居中
        nameLocation: 'middle',
        // 坐标轴名称与轴线之间的距离
        nameGap: 90,
  ...
  useEffect(() => {
    // 获取图表容器
    const ele = document.querySelector('#transactions-chart');
  ...
  return <div className="game-overview-transactions-chart" id="transactions-chart" />;
};

export default GameOverviewTransactionsChart;
