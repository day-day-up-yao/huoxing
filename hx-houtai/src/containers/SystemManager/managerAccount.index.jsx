    ...
    componentWillMount () {
        ...
        columns = [{
            ...
            render: (text) => {
                ...
                if (text === 5) return 'MarsBit中国行管理'
                if (text === 6) return '广告数据管理'
                if (text === 4) return '推送管理员'
                if (text === 7) return '实习编辑'
            }
        }, {
            title: '登陆名/手机号 ',
            dataIndex: 'phoneNum',
                ...
                <Form>
                    ...
                    >
                        {getFieldDecorator('role', {
                            initialValue: String(selectedData.role) || '2'
                        })(
                            <RadioGroup>
                                <Radio disabled value="3">超级管理员</Radio>
                                <Radio value="2">后台管理员</Radio>
                                <Radio value="7">实习编辑</Radio>
                                {/* <Radio value="5">MarsBit中国行</Radio>
                                <Radio value="4">App推送管理</Radio>
                                <Radio value="6">广告数据管理</Radio>
                                <Radio value="7">MarsBit大学管理</Radio> */}
                            </RadioGroup>
                        )}
                    </FormItem>
                    <FormItem
                    ...
                    >
                        {getFieldDecorator('remarks', {
                            rules: [{
                                required: true, message: '备注必须输入，不然就忘了！'
                            }],
                            initialValue: selectedData.remarks || ''
                        })(
                            <TextArea rows={4} className="remarks" placeholder="识别用户"/>
                        )}
                    </FormItem>
                </Form>
            </Modal>
