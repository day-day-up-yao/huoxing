...
class UserLiveIndex extends Component {
    constructor () {
        super()
        this.state = {
            loading: true
    ...
    doSearch (type, data) {
        ...
        let sendData = {
            ...
            displayFlag: filter.displayFlag || '',
...
export default connect(mapStateToProps)(Form.create()(UserLiveIndex))
