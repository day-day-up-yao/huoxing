            ...
            <Spin spinning={this.state.loading} size="large">
                <Row className="item-section">
                    <Col className='item-content'>
                        <p>好了, 本次发布会到此结束, 感谢您的陪伴, 我们下期再见, 好了, 本次发布会到此结束, 感谢您的陪伴, 我们下期再见, MarsBit出品!好了, 本次发布会到此结束, 感谢您的陪伴, 我们下期再见, MarsBit出品!好了, 本次发布会到此结束, 感谢您的陪伴, 我们下期再见, MarsBit出品!好了, 本次发布会到此结束, 感谢您的陪伴, 我们下期再见, MarsBit出品!</p>
                    </Col>
