...
class BannerIndex extends Component {
    ...
    componentWillMount () {
        ...
        columns = [{
            ...
            render: (record) => {
                if (record.type === 1) {
                    return <a target="_blank" href={record.typeLink && record.typeLink.trim() !== '' ? 'http://www.huoxing24.com/newsdetail/' + record.typeLink + '.html' : '#/banner-trList'}>{`${record.typeLink && record.typeLink.trim() !== '' ? 'http://www.huoxing24.com/newsdetail/' + record.typeLink + '.html' : '暂无链接'}`}</a>
                } else if (record.type === 2) {
                    ...
                    return <a target="_blank" href={record.typeLink && record.typeLink.trim() !== '' ? record.typeLink : '#/banner-trList'}>{record.typeLink && record.typeLink.trim() !== '' ? record.typeLink : '暂无链接'}</a>
                } else {
                    return <p>暂无</p>
                }
            }
