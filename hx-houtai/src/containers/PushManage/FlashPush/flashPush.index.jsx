...
import { Table, Row, Col, Modal, message, Spin, Input, Button, Form, Checkbox, Radio, Select } from 'antd'
...
import {getFlashPushList, setSearchQuery, setPageData, addFlashPush} from '../../../actions/flash/flashPush.action'
...
class ManagerFlashPush extends Component {
    ...
    handleChange = (value) => {
        ...
        this.setState({
            ...
            dispatch(getFlashPushList('init', sendData, () => {
                This.setState({
                    loading: false
                })
            }))
    ...
    render () {
        ...
        return <div className="flashPush-index">
            <Row>
                <Col>
                    <span>推送类型：</span>
                    <Select defaultValue={'flash'} style={{ width: 100, marginRight: 15 }} onChange={this.handleChange}>
                ...
                <Form>
                    ...
                    >
                        {getFieldDecorator('terminal', {
                            ...
                            <CheckboxGroup onChange={this.terminalChange}>
                                ...
                                {/* <Checkbox value="3">MarsBit社区APP</Checkbox> */}
                    ...
                    <FormItem
                        ...
                        {getFieldDecorator('id', {
                            initialValue: '',
                            rules: [
                                {required: true, message: '请输入推送 ID！'}
                            ]
                        })(
                            <Input placeholder="推送 ID"/>
                        )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                    ...
                    <FormItem
                        ...
                        {getFieldDecorator('content', {
                            ...
                            <TextArea rows={3} placeholder="推送内容"/>
                        )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                        ...
                        {getFieldDecorator('notifyContent', {
                            ...
                            <TextArea rows={3} placeholder="推送描述" maxLength={200}/>
                        )}
                    </FormItem>
                </Form>
            </Modal>
