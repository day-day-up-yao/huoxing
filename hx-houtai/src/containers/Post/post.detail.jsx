...
import {getPostItemInfo} from '../../actions/post/post.action'
            ...
            {info.id ? <div className="post-detail">
                ...
                <Row className="news-detail-info">
                    ...
                    <Col className="section" {...col}>
                        ...
                        <span
                            className="desc">{`${(info.original && parseInt(info.original) === 1) ? '是' : '否'}`} </span>
                    </Col>
                </Row>
                ...
                {isJsonString(info.coverPic) ? <div>
                            ...
                            if (JSON.parse(info.video).length !== 0) {
                                return <Row className="news-cover-img">
                                    <Col className="section">
                                        ...
                                        <img
                                            className="desc"
                                            onClick={() => this.showModal(JSON.parse(info.coverPic).video_pc)}
                    ...
                    <Row className="news-cover-img">
                        <Col className="section">
                            ...
                            {
                                (JSON.parse(info.coverPic).pc_recommend && JSON.parse(info.coverPic).pc_recommend !== '')
                                    ? <img
                                        className="desc"
                                        onClick={() => this.showModal(JSON.parse(info.coverPic).pc_recommend)}
                                        src={`${JSON.parse(info.coverPic).pc_recommend}`}/>
                                    : <span style={{padding: 6}}>暂无推荐位封面</span>}
                        </Col>
                    </Row>
                    <Row className="news-cover-img">
                        <Col className="section">
