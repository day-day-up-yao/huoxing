...
class VersionUpfile extends Component {
    ...
    handleUpload = () => {
        ...
        const { videoList, id, md5 } = this.state
        ...
        formData.append('channel', 'mars_xs0000')
    ...
    render () {
        ...
        return (<div>
            <Form>
                <Row><Col span={4}><div className="updateTitle">在线安装包上传</div></Col><Col span={8}></Col></Row>
                <FormItem {...formItemLayout} label="密码：">
                    <Input placeholder='请输入上传密码' onChange={this.handleChangePassword} />
                </FormItem>
                <FormItem {...formItemLayout} label="文件MD5：">
                    <Input placeholder='请输入文件MD5' onChange={this.handleChangeMd5} />
                </FormItem>
