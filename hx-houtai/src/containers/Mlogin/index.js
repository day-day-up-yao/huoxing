...
class Mlogin extends Component {
    ...
    render () {
        ...
        return <div className="login-wrap">
            <header className="clearfix"><div className="logo"></div></header>
                    ...
                    <Form onSubmit={this.handleSubmit} className="login-form" name="login">
                        <FormItem name="nickNameOrphoneNum">
                            {getFieldDecorator('nickNameOrphoneNum', {
                                ...
                                <Input onChange={(e) => { this.accountChange(e) }} style={{ height: '40px' }} prefix={<Icon type="user"/>} type="text" placeholder="请输入账号" />
                            )}
                        </FormItem>
                        <FormItem>
                            ...
                            <Row gutter={8}>
                                <Col span={16}>
                                    {getFieldDecorator('phoneCode', {
                                        ...
                                        <Input style={{ height: '40px' }} prefix={<Icon type="cloud-o"/>} placeholder="短信验证码" />
                                    )}
                                </Col>
                                <Col span={8}>
                                    <Button onClick={this.getSmsCodeFunc} style={{ height: '40px' }}>{this.state.smsCodeBtnTxt}</Button>
                                </Col>
                            </Row>
                        </FormItem>
                        <FormItem name="password">
                            {getFieldDecorator('password', {rules: [{required: true, message: '请输入密码'}], initialValue: ''})(
                                <Input style={{ height: '40px' }} prefix={<Icon type="lock"/>} type="password" placeholder="请输入密码"/>
                            )}
                        </FormItem>
                        <FormItem>
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(Mlogin))
