    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                topic.descriptionForSEO = values.descriptionForSEO
                ...
                delete values.descriptionForSEO
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    >
                        {getFieldDecorator('keyword', {
                            ...
                            <Input className="specialTopic-tags" placeholder="专题 KeyWords (用于 SEO 优化), 多个词条请用英文逗号隔开!"/>
                        )}
                    </FormItem>
                    ...
                    >
                        {getFieldDecorator('description', {
                            initialValue: '',
                            rules: [{required: true, message: '请输入专题的介绍！'}]
                        })(
                            <Input className="specialTopic-tags" placeholder="专题顶部介绍"/>
                        )}
                    </FormItem>
                    ...
                    <FormItem
                        ...
                        label="DescForSEO "
                    >
                        {getFieldDecorator('descriptionForSEO', {
                            initialValue: '',
                            rules: [{message: '请输入专题的 SEO 描述！'}]
                        })(
                    ...
                    >
                        <div className="dropbox">
                            ...
                            <span className="cover-img-tip">用于专题页面的背景图展示, 长宽比例: <font style={{color: 'red'}}>1920 * 300</font></span>
                        </div>
                    </FormItem>
