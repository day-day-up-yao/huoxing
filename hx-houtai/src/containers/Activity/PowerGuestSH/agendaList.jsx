    ...
    delIco (item) {
        ...
        confirm({
            ...
            onOk () {
                ...
                axiosAjax('POST', '/power5/deleteAgenda', {...sendData}, (res) => {
                    if (res.code === 1) {
            ...
            <Row>
                <Col>
                    ...
                    <Select defaultValue='' style={{width: 120, marginRight: 15}} onChange={this.handleChangeDate}>
                        ...
                        <Option value="8月10日">8月10日</Option>
                        <Option value="8月11日">8月11日</Option>
                        <Option value="8月12日">8月12日</Option>
                        <Option value="8月13日">8月13日</Option>
                    </Select>
                    <span>会场：</span>
...
const mapStateToProps = (state) => {
    return {
        agendaList: state.powerSHAgendaList.agendaList,
        agendaListType: state.powerSHAgendaList.agendaListType,
        pageData: state.powerSHAgendaList.pageData
    }
}
