...
} from '../../../actions/activity/powerSH/guestList.action'
    ...
    delIco (item) {
        ...
        confirm({
            ...
            onOk () {
                ...
                axiosAjax('POST', '/power5/deleteCooperation', {...sendData}, (res) => {
                    if (res.code === 1) {
            ...
            <Row>
                <Col>
                    ...
                    <Select defaultValue='' style={{ width: 120, marginRight: 15 }} onChange={this.handleChange}>
                        ...
                        <Option value="0">主办方</Option>
                        <Option value="5">首席战略合作</Option>
                        <Option value="1">战略合作</Option>
                        <Option value="7">合作伙伴</Option>
                        <Option value="6">MarsBit生态支持</Option>
                        <Option value="3">特邀媒体</Option>
                        <Option value="2">战略媒体</Option>
                        <Option value="4">社区支持</Option>
                    </Select>
...
const mapStateToProps = (state) => {
    return {
        cooperationList: state.powerSHCooperation.cooperationList,
        pageData: state.powerSHCooperation.pageData
    }
}
