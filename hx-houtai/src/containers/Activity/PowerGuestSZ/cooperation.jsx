    ...
    delIco (item) {
        ...
        confirm({
            ...
            onOk () {
                ...
                axiosAjax('POST', '/power6/deleteCooperation', {...sendData}, (res) => {
                    if (res.code === 1) {
...
const mapStateToProps = (state) => {
    return {
        cooperationList: state.powerSZCooperation.cooperationList,
        pageData: state.powerSZCooperation.pageData
    }
}
