    ...
    delIco (item) {
        ...
        confirm({
            ...
            onOk () {
                ...
                axiosAjax('POST', '/power4/deleteAgenda', {...sendData}, (res) => {
                    if (res.code === 1) {
            ...
            <Row>
                <Col>
                    ...
                    <Select defaultValue='' style={{width: 120, marginRight: 15}} onChange={this.handleChangeDate}>
                        ...
                        <Option value="6月20日">6月20日</Option>
                        <Option value="6月21日">6月21日</Option>
                        <Option value="6月22日">6月22日</Option>
                        <Option value="6月23日">6月23日</Option>
                        <Option value="6月24日">6月24日</Option>
                    </Select>
                    <span>会场：</span>
...
const mapStateToProps = (state) => {
    return {
        agendaList: state.powerYNAgendaList.agendaList,
        agendaListType: state.powerYNAgendaList.agendaListType,
        pageData: state.powerYNAgendaList.pageData
    }
}
