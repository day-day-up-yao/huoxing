...
} from '../../../actions/activity/powerYN/guestList.action'
    ...
    delIco (item) {
        ...
        confirm({
            ...
            onOk () {
                ...
                axiosAjax('POST', '/power4/deleteCooperation', {...sendData}, (res) => {
                    if (res.code === 1) {
            ...
            <Row>
                <Col>
                    ...
                    <Select defaultValue='' style={{ width: 120, marginRight: 15 }} onChange={this.handleChange}>
                        ...
                        <Option value="5">首席战略合作分类</Option>
                    </Select>
...
const mapStateToProps = (state) => {
    return {
        cooperationList: state.powerYNCooperation.cooperationList,
        pageData: state.powerYNCooperation.pageData
    }
}
