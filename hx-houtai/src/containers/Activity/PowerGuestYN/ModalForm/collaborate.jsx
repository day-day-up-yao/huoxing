...
class CollectionCreateForm extends Component {
    ...
    collaborateSubmit () {
        ...
        form.validateFields((err, values) => {
            ...
            let url = this.props.data.id ? '/power4/updateCooperation' : '/power4/addCooperation'
            axiosAjax('POST', url, {
                    ...
                    <FormItem
                        ...
                        {getFieldDecorator('companyType', {
                            ...
                            <RadioGroup>
                                ...
                                <Radio value="1">战略合作</Radio>
                                <Radio value="2">战略媒体</Radio>
                                <Radio value="3">特邀媒体</Radio>
                                <Radio value="4">社区支持</Radio>
                                <Radio value="5">首席战略合作分类</Radio>
                            </RadioGroup>
                        )}
                    </FormItem>
                    <FormItem
