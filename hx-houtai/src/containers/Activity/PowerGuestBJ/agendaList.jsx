...
class PowerAgendaList extends Component {
    ...
    componentWillMount () {
        ...
        columns = [{
            ...
            key: 'guestIntroduce',
            width: 250,
            render: (record) => (<p>{record.guestIntroduce}</p>)
        }, {
            title: '操作',
            key: 'action',
            render: (item) => {
            ...
            <Row>
                <Col>
                    ...
                    <Select defaultValue='' style={{width: 120, marginRight: 15}} onChange={this.handleChangeDate}>
                        ...
                        <Option value="8月20日">8月20日</Option>
                        <Option value="8月21日">8月21日</Option>
                    </Select>
                    <span>会场：</span>
...
const mapStateToProps = (state) => {
    return {
        agendaList: state.powerBjAgendaList.agendaList,
        agendaListType: state.powerBjAgendaList.agendaListType,
        pageData: state.powerBjAgendaList.pageData
    }
}
