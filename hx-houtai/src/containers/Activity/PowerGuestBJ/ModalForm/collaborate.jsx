...
class CollectionCreateForm extends Component {
    ...
    collaborateSubmit () {
        ...
        form.validateFields((err, values) => {
            ...
            let url = this.props.data.id ? '/power2/updateCooperation' : '/power2/addCooperation'
            axiosAjax('POST', url, {
                ...
                <Form>
                    ...
                    <FormItem
                        ...
                        {getFieldDecorator('companyType', {
                            ...
                            <RadioGroup>
                                <Radio value="0">联合发起方</Radio>
                                <Radio value="1">全球战略合作媒体</Radio>
                                <Radio value="2">星级合作伙伴</Radio>
                                <Radio value="3">首席合作媒体</Radio>
                                <Radio value="4">社区战略合作媒体</Radio>
                                <Radio value="5">特别支持媒体</Radio>
                                <Radio value="6">战略合作媒体</Radio>
                                <Radio value="7">合作伙伴</Radio>
                                <Radio value="8">独家售票平台</Radio>
                            </RadioGroup>
                        )}
                    </FormItem>
                    <FormItem
