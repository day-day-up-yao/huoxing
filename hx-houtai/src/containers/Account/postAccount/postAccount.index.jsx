...
import { Table, Row, Col, Modal, message, Spin, Select, Input, Form, Upload, Icon, Button, Radio } from 'antd'
...
class PostAccountIndex extends Component {
    ...
    updateAccount (item) {
        ...
        this.setState({
            ...
            image: item.iconurl,
            visible: true,
            identityAuth: item.identityAuth
        })
    }
    ...
    render () {
        ...
        const {imageList, visible, loading, previewVisible, previewImage, deliveryModal, bulkImport} = this.state
        const uploadButton = (
            <div>
                <Icon type="plus"/>
        ...
        return <div className="postAccount-index">
            <Row>
                <Col>
                    ...
                    <Button type="primary" style={{margin: '0 0 0 15px'}} onClick={this.bulkImportShow}>批量导入</Button>
                </Col>
            </Row>
            <div className="mt30">
            ...
            >
                <Form>
                    ...
                    <Row className="" style={{margin: '0 20px 20px'}}>
                    ...
                    <Row className="" style={{margin: '0 0 20px'}}>
                        <Col className="section">
                            ...
                            {getFieldDecorator('identityDesc', {
                                ...
                                initialValue: selectedData.identityDesc === '' ? '' : selectedData.identityDesc
                            })(
                                <Input
                                    style={{width: 360}}
                                    placeholder="认证信息"
            ...
            />
            <BulkImport show={bulkImport} close={this.bulkImportHide}/>
        </div>
    }
}
