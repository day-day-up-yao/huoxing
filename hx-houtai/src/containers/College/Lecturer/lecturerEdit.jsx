...
import {getLecturerItemInfo} from '../../../actions/college/lecturer.action'
...
class LecturerEdit extends Component {
    ...
    componentWillMount () {
        ...
        dispatch(getLecturerItemInfo({'id': location.query.id}, (data) => {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                axiosAjax('post', '/college/lecturer/update', values, (res) => {
                    if (res.code === 1) {
                        message.success('修改成功')
                        hashHistory.push('/college-lecList')
                    } else {
...
const mapStateToProps = (state) => {
    return {
        userInfo: state.lecturerInfo.info
    }
}

export default connect(mapStateToProps)(Form.create()(LecturerEdit))
