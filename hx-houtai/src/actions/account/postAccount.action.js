...
import {axiosAjax, axiosAjaxPromise} from '../../public/index'
...
// 请求列表 pure ajax
export const postAccountListPure = () => axiosAjaxPromise({
    type: 'get',
...
// 导入新闻 pure ajax
export const importNews = (passportId) => axiosAjaxPromise({
    type: 'post',
    url: '/account/author/importnews',
    params: {
