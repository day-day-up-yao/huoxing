...
var env = "production";
var folderAddressTest = 'news.marslib.com';
var folderAddressPrd = 'news.huoxing24.com';
/** @desc 测试服 */
...
if (env === 'production') {
  config = {
    redisIp: 'r-j6cwzd7dvux3iybidepd.redis.rds.aliyuncs.com',
    // 外网IP:39.105.139.238
...
var external_debug_ = __webpack_require__(16);
...
var external_compression_ = __webpack_require__(28);
...
var external_express_winston_ = __webpack_require__(14);
...
var typeof_ = __webpack_require__(7);
...
var external_js_base64_ = __webpack_require__(30);

// EXTERNAL MODULE: external "blueimp-md5"
var external_blueimp_md5_ = __webpack_require__(31);
...
__webpack_require__(46); // 确保项目根目录存在logs文件夹
...
var external_http_proxy_middleware_ = __webpack_require__(33);
...
var external_express_promise_router_ = __webpack_require__(10);
...
var external_react_redux_ = __webpack_require__(19);

// EXTERNAL MODULE: external "react-router-config"
var external_react_router_config_ = __webpack_require__(37);

// EXTERNAL MODULE: external "@loadable/server"
var external_loadable_server_ = __webpack_require__(20);

// EXTERNAL MODULE: external "react-i18next"
var external_react_i18next_ = __webpack_require__(21);
...
var external_redux_thunk_ = __webpack_require__(38);
...
// CONCATENATED MODULE: ./assets/redux/reducers/author.js


 // import { from } from 'rxjs'

var author_initState = {
  authorVideoList: {
    inforList: []
  },
  authorNewsList: {
...
/* harmony default export */ var reducers_author = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : author_initState;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  ...
  switch (action.type) {
    ...
    case GETCOLLECTAUTHOR:
      return objectSpread_default()({}, state, {
        collectAuthor: action.data
      });

    case GETAUTHORACHIEVE:
      return objectSpread_default()({}, state, {
        authorAchieve: action.data
      });
...
// CONCATENATED MODULE: ./assets/redux/reducers/flash.js
...
/* harmony default export */ var flash = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : flash_initState;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case GETFLASHCHANNEL:
      return objectSpread_default()({}, state, {
        flashChannel: action.data
      });

    case GETIMPORTANTFLASH:
      return objectSpread_default()({}, state, {
        flashImportant: action.data
      });

    case GETNEWSRANKINGS:
      return objectSpread_default()({}, state, {
        newsRankings: action.data
      });

    case GETFLASHDETAILS:
      return objectSpread_default()({}, state, {
        flashDetails: action.data
      });

    case DETAILSUPORDOWN:
      var newDetails = objectSpread_default()({}, state.flashDetails, action.data, {
        type: action.params.status
      });

      return objectSpread_default()({}, state, {
        flashDetails: newDetails
      });
...
// CONCATENATED MODULE: ./assets/redux/reducers/noticeDetail.js


var noticeDetail_initState = {
  noticeObj: {}
};
/* harmony default export */ var noticeDetail = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : noticeDetail_initState;
  var action = arguments.length > 1 ? arguments[1] : undefined;
...
var notice_GETNOTICEDETAIL = 'get-notice-detail';
// CONCATENATED MODULE: ./assets/redux/reducers/notice.js


var notice_initState = {
  noticeObj: {},
  bourseObj: {},
  statisticsObj: {},
  noticeDetailObj: {}
};
/* harmony default export */ var notice = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : notice_initState;
  var action = arguments.length > 1 ? arguments[1] : undefined;
  ...
  switch (action.type) {
    ...
    case GETBOURSELIST:
      return objectSpread_default()({}, state, {
        bourseObj: action.data
      });

    case GETBOURSESTATISTICSLIST:
      return objectSpread_default()({}, state, {
        statisticsObj: action.data
      });

    case notice_GETNOTICEDETAIL:
      return objectSpread_default()({}, state, {
        noticeDetailObj: action.data
      });
...
/* harmony default export */ var reducers_flash = (Object(external_redux_["combineReducers"])({
...
var news_GETAUTHORINFO = 'get-author-info'; // 获取作者列表
...
var config_server = __webpack_require__(11);
...
var TLSSigAPIv2 = __webpack_require__(39);
...
var external_request_ = __webpack_require__(22);
...
var sign = function sign(jsapiTicket, url) {
  ...
  var JsSHA = __webpack_require__(49);
...
var external_redis_ = __webpack_require__(40);
...
var external_i18next_ = __webpack_require__(23);
...
var external_i18next_express_middleware_ = __webpack_require__(24);
...
var external_i18next_node_fs_backend_ = __webpack_require__(41);
...
var zh_tw = __webpack_require__(43);
