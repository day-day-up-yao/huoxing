...
class AppWrapper extends Component {
        ...
        history.listen((location) => {
            ...
            promises.push(
                store.dispatch.public.setUserInfo({
                    accountId: Cookies.get(cookiesName.accountId),
                    cToken: Cookies.get(cookiesName.cToken),
    ...
    componentDidMount () {
        /** @desc 用户信息设置。注:若页面路由添加cdn用此地方设置，render.js中注释 */
        // this.props.dispatch.public.setUserInfo({
        //     accountId: Cookies.get(cookiesName.accountId),
        //     cToken: Cookies.get(cookiesName.cToken),
        //     userId: Cookies.get(cookiesName.userId)
        // })
