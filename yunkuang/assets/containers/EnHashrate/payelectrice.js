...
export default ({ setTopay, setPrompt, langua, calculid, electype }) => {
    ...
    return <div className="topay">
        ...
        <div className="paytype" style={{ display: paytype.flage ? 'flex' : '' }}>
            <div className="paytype-con">
                ...
                <Payment noBankPay={true} costorder={true} clientTradeNo={paytype.client} orderType="electricity-recharge"/>
