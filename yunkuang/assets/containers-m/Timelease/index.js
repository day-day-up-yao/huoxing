...
import './index.scss'
import togetherimg from '../../public/imgs/timeleasem.png'
            ...
            <div className="HomeNew_C_y" id='productlist'>
                ...
                <div className="HomeCon-m" id='#productlists'>
                    {Array.isArray(productList) && productList.map(function (item, index) {
                        return <a className="HomeCon_C-m" href={`/product/${item.id}`} key={item.id}>
                            <div className="down">
                            ...
                            <div className="HomeCon_C_bottom">
                                ...
                                <div className="HomeCon_C_bottom_right">
                                    <p className="HomeCon_C_bottom_right_span">￥ {item.price}</p>
                                </div>
                            </div>
