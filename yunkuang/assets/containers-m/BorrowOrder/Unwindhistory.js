...
export default () => {
    ...
    const [statnum, setStatnum] = useState()
                ...
                <div className="css-y9kj8x">
                    ...
                    <div className="sc-htpNat cyiKwg">
                        ...
                        <button data-bn-type="button" className="css-dq59xs" onClick={() => {
                            if (endtime || loancurrcy || margincurrcy || orderCodeid.current.value !== '' || starttime || statnum) {
                                ...
                                <table style={{ tableLayout: 'fixed' }}>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="rc-table-cell">时间</th>
                                            <th className="rc-table-cell">抵押币种</th>
                                            <th className="rc-table-cell">平仓使用金额</th>
                                            <th className="rc-table-cell">平仓剩余抵押金额</th>
                                            <th className="rc-table-cell">借款币种</th>
                                            <th className="rc-table-cell">负债总和</th>
                                            <th className="rc-table-cell">借款金额</th>
                                            <th className="rc-table-cell">应计利息</th>
                                            <th
                                    ...
                                    {pclist.length > 0 ? (
                                        pclist.map((item, index) => {
                                            return <thead key={index} style={{ background: '#fff', borderBottom: '1px solid #eee' }} key={index}>
                                                <tr>
                                                    <th className="rc-table-cell">{item.orderId}</th>
                                                    <th className="rc-table-cell">{formatTime(item.triggerAt, 'yyyy-MM-dd hh:mm:ss')}</th>
                                                    <th className="rc-table-cell">{item.pledgeSymbol}</th>
                                                    <th className="rc-table-cell">{item.coveredAmount}</th>
                                                    <th className="rc-table-cell">{item.fundRest}</th>
                                                    <th className="rc-table-cell">{item.loanSymbol}</th>
                                                    <th className="rc-table-cell">{item.totalDebt}</th>
                                                    <th className="rc-table-cell">{item.loanOrderDetai.marginAmount}</th>
                                                    <th className="rc-table-cell">{item.interestRemaining}</th>
                                                    <th
                                                        className="rc-table-cell hide rc-table-cell-fix-right rc-table-cell-fix-right-first"
                        ...
                        pclist.map((item, index) => {
                            return <div className="css-jg500d" key={index}>
                                <div className="css-ymjgx1">
                                    ...
                                    <div data-bn-type="text" className="css-1r2jm08">{item.orderId}</div>
                                </div>
                                <div className="css-ymjgx1">
                                    <div data-bn-type="text" className="css-1qp5tsr">时间</div>
                                    <div data-bn-type="text" className="css-1r2jm08">{formatTime(item.triggerAt, 'yyyy-MM-dd hh:mm:ss')}</div>
                                </div>
                                <div className="css-ymjgx1">
                                    <div data-bn-type="text" className="css-1qp5tsr">抵押币种</div>
                                    <div data-bn-type="text" className="css-1r2jm08">{item.pledgeSymbol}</div>
                                </div>
                                <div className="css-moreymjgx1">
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">平仓使用金额</div>
                                        <div data-bn-type="text" className="css-1r2jm08">{item.coveredAmount}</div>
                                    </div>
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">平仓剩余抵押金额</div>
                                        <div data-bn-type="text" className="css-1r2jm08">{item.fundRest}</div>
                                    </div>
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">借款币种</div>
                                        <div data-bn-type="text" className="css-1r2jm08">{item.loanSymbol}</div>
                                    </div>
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">负债总和</div>
                                        <div data-bn-type="text" className="css-1r2jm08">{item.totalDebt}</div>
                                    </div>
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">借款金额</div>
                                        <div data-bn-type="text" className="css-1r2jm08">{item.loanOrderDetai.marginAmount}</div>
                                    </div>
                                    <div className="css-ymjgx1">
                                        <div data-bn-type="text" className="css-1qp5tsr">应计利息</div>
                                    ...
                                    <div className="css-ymjgx1">
                                        ...
                                        <div data-bn-type="text" className="css-1r2jm08">
                                            {item.coverStatus === 0 ? '进行中' : item.coverStatus === 1 ? '已平仓' : item.coverStatus === 2 ? '已平仓' : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>
